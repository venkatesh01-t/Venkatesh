...
function lazyLoadChartJs() {
    ...
    script.src = window.location.pathname.includes('/sections/') ? "../js/vendor/chart.min.js" : "js/vendor/chart.min.js";
    script.defer = true;
    script.onload = () => {
        renderRadarChart();
    };
...
function ensureEmailJs() {
    return new Promise((resolve) => {
        ...
        const script = document.createElement('script');
        script.src = window.location.pathname.includes('/sections/') ? "../js/vendor/email.min.js" : "js/vendor/email.min.js";
        script.defer = true;
        script.onload = () => {
            emailJsLoaded = true;
            if (typeof emailjs !== 'undefined') {
        ...
        script.onerror = () => {
            // Edge CDN Fallback
            const fallback = document.createElement('script');
            fallback.src = "https://cdn.jsdelivr.net/npm/@emailjs/browser@4/dist/email.min.js";
            fallback.defer = true;
            fallback.onload = () => {
                emailJsLoaded = true;
                if (typeof emailjs !== 'undefined') {
